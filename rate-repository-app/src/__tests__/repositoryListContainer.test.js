...
describe('RepositoryList', () => {
  describe('RepositoryListContainer', () => {
    it('renders repository information correctly', () => {
      ...
      // use screen.debug() to check how it is rendering
      // repositoryListContainer expects a prop called repositories
      ...
      expect(secondRepositoryItem).toHaveTextContent('Flexible promise-based React data loade')
